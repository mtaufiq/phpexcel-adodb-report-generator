 ...
 */
 var imgRem = "<img src='http://127.0.0.1:8000/web/images/img-rem.png' alt='remove' />";
 var imgAdd = "<img src='http://127.0.0.1:8000/web/images/img-add.png' alt='remove' />Add another item";
    ...
    $.fn.formset = function(opts)
    {
        ...
        $(this).each(function(i) {
            ...
            if ($(this).is('TR')) {
                ...
                $(this).children(':last').append('<a class="' + options.deleteCssClass +'" href="javascript:void(0)">' + imgRem + '</a>');
        ...
        if ($(this).length) {
            ...
            if ($(this).attr('tagName') == 'TR') {
                ...
                $(this).parent().append('<tr><td colspan="' + numCols + '"><a class="' + options.addCssClass + '" href="javascript:void(0)">' + imgAdd + '</a></tr>');
