...
$cdbReport = new CashDisbursementSummary($details , $parameters);
$cdbReport->create();
?>
...
<fieldset><legend>Report Preview - <a href="<?php echo $cdbReport->report->getFileLink(); ?>" target="_self">click here to download</a></legend>
